...
5. External services sidenav section in SYS is missing links to other services like Resend, Graphana or adminer. Add them to this section, similar to other once. It might require changing condition statements. 
