#!/usr/bin/env python
"""
Task 65 - Test template rendering performance
"""
import os
import sys
import django
...
print("="*80)
print("TESTING VIEW PERFORMANCE WITH DEBUG=False (production-like)")
print("="*80)

# Test with DEBUG=False (like production)
...
print()
print("="*80)
print("TESTING VIEW PERFORMANCE WITH DEBUG=True (query logging)")
print("="*80)

# Test with DEBUG=True to see queries
